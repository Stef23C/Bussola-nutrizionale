...
const DIET_GUIDE = {
  ...
  antiinfiammatoria: { it:{
    ...
    prefer: ["Pesce azzurro e grasso (ricco di omega-3)","Verdura a foglia verde e verdura colorata","Frutti di bosco","Frutta secca e semi (chia, lino)","Olio extravergine d'oliva","Spezie come curcuma e zenzero","Pseudocereali e cereali integrali (quinoa, grano saraceno, amaranto, teff, avena)"],
    ...
    prefer: ["Poisson gras (riche en oméga-3)","Légumes à feuilles vertes et légumes colorés","Fruits rouges","Fruits à coque et graines (chia, lin)","Huile d'olive extra vierge","Épices comme le curcuma et le gingembre","Pseudo-céréales et céréales complètes (quinoa, sarrasin, amarante, teff, avoine)"],
...
["Quinoa (cruda)","Quinoa (cru)","Cereali","Céréales",368,14.1,64.2,6.1,7.0,0.01,T(1,1,1,1,1)],
...
["Grano saraceno (crudo)","Sarrasin (cru)","Cereali","Céréales",343,13.3,71.5,3.4,10.0,0.0,T(1,1,1,1,1)],
["Amaranto (crudo)","Amarante (crue)","Cereali","Céréales",371,13.6,65.2,7.0,6.7,0.02,T(1,1,1,1,1)],
["Teff (crudo)","Teff (cru)","Cereali","Céréales",367,13.3,73.0,2.4,8.0,0.01,T(1,1,1,1,1)],
